#!/bin/bash
# build_cli_fixed2.sh - Simpler Dvx3 CLI build script
...
echo "[2/3] Compiling CLI..."
# Compile main.vala and dvx3-cli.vala together with libdvx3.c
valac --pkg glib-2.0 --pkg $GIO_PKG --pkg json-glib-1.0 \
    --vapidir=vala-extra-vapis --pkg libsodium \
    $VALA_DEFINES \
    -C -d build/cli-main \
